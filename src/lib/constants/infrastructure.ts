/**
 * Infrastructure constants for Open Studio
 * Simplified version from Supabase Studio - only what's needed for local usage
 */

import type { components } from 'data/api'

export const AWS_REGIONS_DEFAULT = 'EAST_US'
export const FLY_REGIONS_DEFAULT = 'SOUTHEAST_ASIA'
