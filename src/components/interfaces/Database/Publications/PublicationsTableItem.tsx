import type { PostgresPublication, PostgresTable } from '@supabase/pg-meta'
...
import { Badge, Switch, TableCell, TableRow, Tooltip, TooltipContent, TooltipTrigger } from '@/lib/ui'
